...
<template>
    <main>
        <div
            class="about  bg-light position-fixed rounded-3  mx-auto d-flex flex-column position-absolute">
        </div>
        <h1 class="pt-5">About myself</h1>
        <div class="opacity-100 container  pb-0 mx-auto z-3 presentation position-relative">
            <div class="row p-0 m-0 row-cols-1 g-5 m-auto ">
                <div class="col fs-4 p-0 fw-bold text-light-emphasis display-1  rounded-5 shadow-lg ">
                        <div class="shadow-lg card rounded-5 mx-auto  ">
                            ...
                            <div class="card-body">
                                <p class="card-text fs-5 p-5">Sono un Web Developer con una passione innata per il risultato e la
                                    funzionalità. La mia
                                    principale forza risiede nella mia capacità di lavorare in team, collaborando con altri
                                    professionisti per raggiungere obiettivi comuni. Sono sempre pronto ad affrontare nuove
                                    sfide e
                                    ad imparare continuamente, poiché credo che il miglioramento personale sia fondamentale
                                    per
                                    avere successo nel settore tecnologico in continua evoluzione. La mia determinazione nel
                                    perseguire la crescita personale mi ha portato a intraprendere il corso Boolean, dove ho
                                    avuto
                                    l'opportunità di mettere in pratica le mie competenze e realizzare i miei progetti.
                                </p>
                            </div>
                        </div>
                ...
                <div class="col fs-4 p-0 fw-bold text-light-emphasis display-1 mx-auto rounded-5 shadow-lg">
                    <div class="shadow-lg card rounded-5">
                            <div class="card-header ">
                                <h4>
                                    Skills
                                </h4>
                            ...
                            <div class="card-body">
                                <ul class=" ">
                                    <li class=" fs-5 ">Risoluzione di problemi</li>
                                    <li class=" fs-5 ">Controllo qualità</li>
                                    <li class=" fs-5 ">Concettualizzazione di progetti</li>
                                </ul>
                            </div>
                        </div>
                </div>
                <div class="col fs-4 p-0 fw-bold text-light-emphasis display-1 mx-auto rounded-5 shadow-lg">
                    <div class="languages shadow-lg card rounded-5 ">
                            <div class="card-header">
                                Languages
                            </div>
                            <div class="card-body">
                                <ul class=" d-flex flex-lg-row row text-center text-sm-start row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-8">
                                    ...
                                    <li class="list-unstyled col">
                                        <svg xmlns:dc="http://purl.org/dc/elements/1.1/"
                                            ...
                                            height="60" viewBox="0 0 120 60" version="1.1" id="svg901"
                                            ...
                                            <sodipodi:namedview pagecolor="#ffffff" bordercolor="#666666" borderopacity="1"
                                                ...
                                                inkscape:window-width="1506" inkscape:window-height="702" id="namedview903"
                                                showgrid="false" inkscape:zoom="1.4605809" inkscape:cx="37.31392"
                                                inkscape:cy="46" inkscape:window-x="70" inkscape:window-y="27"
                                                inkscape:window-maximized="0" inkscape:current-layer="svg901"
                                                inkscape:pagecheckerboard="true" />
                                            <path style="fill:#41b883;fill-rule:evenodd;stroke-width:0.40281391"
                                                inkscape:connector-curvature="0" id="path893"
                                                d="m 43.482731,11.952421 h 8.482051 L 30.547167,48.860245 8.9885682,11.952421 h 8.6749998 l 12.883599,22.219215 z" />
                                            <path style="fill:#35495e;fill-rule:evenodd;stroke-width:0.40281391"
                                                inkscape:connector-curvature="0" id="path895"
                                                d="m 35.466734,11.944897 h 8.067154 L 30.535889,34.210435 17.642218,11.944897 h 7.941074 l 4.952597,8.57188 z" />
                                            <path style="fill:#010101;fill-rule:evenodd;stroke-width:0.50266033"
                                                inkscape:connector-curvature="0" id="path897"
                                    ...
                                    <li class="list-unstyled col">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="60"
                                            ...
                                            <g transform="matrix(.037376 0 0 .037376 1.069994 -1.319339)"
                                                fill-rule="evenodd">
                                                <path
                                    ...
                                    <li class="list-unstyled col">
                                        <svg height="60" id="svg3430" version="1.1" viewBox="0 0 711.20123 383.5975"
                                            width="120" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:cc="http://creativecommons.org/ns#"
                                    ...
                                    <li class="list-unstyled col">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="60">
                                            ...
                                            <path d="M82.07 12.06h31.637l-2.882 32.288L97.87 47.94l-12.92-3.587z"
                                                fill="#e44d26" />
                                    ...
                                    <li class="list-unstyled col">
                                        <svg xmlns:dc="http://purl.org/dc/elements/1.1/"
                                            ...
                                            xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd"
                                            xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" width="120"
                                            height="60" viewBox="0 0 120 60" id="svg3476" version="1.1"
                                            inkscape:version="0.92.4 (5da689c313, 2019-01-14)"
                                            ...
                                            <sodipodi:namedview id="base" pagecolor="#ffffff" bordercolor="#666666"
                                                ...
                                                fit-margin-bottom="0" inkscape:window-width="1850"
                                                inkscape:window-height="1016" inkscape:window-x="70" inkscape:window-y="27"
                                            ...
                                            <g inkscape:label="Calque 1" inkscape:groupmode="layer" id="layer1"
                                                transform="translate(-193.633,-732.11218)">
                                                <g id="g29" transform="translate(-10.821126,3.1151727)">
                                                    <path style="stroke-width:0.31431133" id="path2999"
                                                        d="m 257.17003,747.19755 h 17.28712 v 7.22917 h -10.05796 v 7.22916 h 10.05796 v 7.22916 h -17.28712 z"
                                                        inkscape:connector-curvature="0" />
                                                    <path style="stroke-width:0.31431133" id="path3001"
                                                        ...
                                                        inkscape:connector-curvature="0" />
                                                    <path style="stroke-width:0.31431133" id="path3003"
                                                ...
                                                <g id="g37"
                                                    transform="matrix(0.60400616,0,0,0.60400616,83.235735,307.26789)">
                                                    <polygon
                                                        transform="matrix(0.17578125,0,0,0.17578125,180.51392,698.3622)"
                                                        id="polygon2989"
